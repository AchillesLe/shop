                    ...
                    <div className="animate form login_form">
                        <section className="login_content">
                            <form>
                                ...
                                <div>
                                    <a className="btn btn-default submit" href="/admin/home">
                                        Log in
                                    </a>
                                ...
                                <div className="separator">
                                    ...
                                    <div>
                                        <h1>
                                            <i className="fa fa-paw" /> Gentelella Alela!
                                        </h1>
                                        <p>
                                            ©2016 All Rights Reserved. Gentelella Alela! is a
                                            Bootstrap 3 template. Privacy and Terms
                                        </p>
                                    </div>
                                </div>
                            </form>
                        ...
                        <section className="login_content">
                            <form>
                                ...
                                <div className="separator">
                                    <p className="change_link">
                                        Already a member ?
                                        <a href="#signin" className="to_register">
                                            {" "}
                                            Log in{" "}
                                        </a>
                                    </p>
